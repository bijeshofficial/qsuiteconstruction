(function ($) {
  ...
  swiperslider.each(function () {
    ...
    if (
      jQuery(carouselElement).hasClass('pbmit-element-service-style-1') ||
      jQuery(carouselElement).hasClass('pbmit-element-testimonial-style-2')
    ) {
      c_counter = true;
      var totalslide = jQuery(carouselElement).find(
        'article:not(".swiper-slide-duplicate")'
      ).length;
      var cal = Math.round((1 * 100) / totalslide);
      header_area.append(
        '<div class="pbmit-fld-contents"><div class="pbmit-circle-outer" data-digit="' +
          cal +
          '" data-fill="#b8967e" data-emptyfill="#f6f6f6" data-before=""  data-thickness="2" data-size="100"><div class="pbmit-circle"><div class="pbmit-fid-inner"></div></div></div></div>'
      );

      var elm = jQuery(carouselElement)
        .closest('section')
        .find('.pbmit-circle');
    ...
    if (carouselElement.hasClass('marquee')) {
      ...
      var swiper = new Swiper('.pbmit-element-viewtype-carousel-' + x, {
        ...
        on: {
          ...
          beforeInit: function () {
            numOfSlides = jQuery(
              '.pbmit-element-viewtype-carousel-' + x + ' .swiper-slide'
            ).length;
          },
        },
      });
...
/* ====================================== */
  ...
  Count Down
  -------------------------------------*/
  $('.active-onhover .pbmit-static-box-style-1:nth-child(2)').addClass(
  ...
  $('.active-onhover .pbmit-static-box-style-1')
    .mouseover(function () {
      ...
      $('.pbmit-static-box-style-1', main_row).removeClass(
        'pbmit-mihbox-hover-active'
      );
    ...
    .mouseout(function () {
      ...
      $('.pbmit-static-box-style-1:nth-child(2)', main_row).addClass(
        'pbmit-mihbox-hover-active'
      );
    });
...
if (jQuery('.pbmit-element-viewtype-masonry').length > 0) {
  jQuery('.pbmit-element-viewtype-masonry').each(function () {
    ...
    let $grid = jQuery('.pbmit-element-posts-wrapper', main_ele).masonry({
      itemSelector:
        '.pbmit-blog-style-3,.pbmit-portfolio-style-3,.pbmit-portfolio-style-2',
      columnWidth:
        '.pbmit-blog-style-3,.pbmit-portfolio-style-3,.pbmit-portfolio-style-2',
      gutter: 0,
